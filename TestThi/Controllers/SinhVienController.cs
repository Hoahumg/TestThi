    ...
    public class SinhVienController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.SinhViens != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.SinhViens'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaSinhVien,HoTen,MaLop")] SinhVien sinhVien)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ApplicationDbContext.SinhViens'  is null.");
            }
            var sinhVien = await _context.SinhViens.FindAsync(id);
            if (sinhVien != null)
            {
